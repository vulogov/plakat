...
#let title-page = {
  ...
  v(0.4em)
  text(size: 30pt, weight: "bold", tracking: 0.02em)[#upper("THE STORM")]
  v(0.5em)
  text(size: 17pt, weight: "regular", tracking: 0.03em)[#upper("Wherein the vessel meets its first peril")]
  v(0.6em)
  v(1em)
  text(size: 11pt, weight: "regular", style: "italic")[#"The wind blew hard, and the sea ran mountains high."]
  v(0.6em)
  v(0.6em)
  text(size: 10pt, weight: "regular", tracking: 0.02em)[#smallcaps("The Author is nearly lost overboard, the mainmast is sprung,")]
  v(0.15em)
  text(size: 10pt, weight: "regular", tracking: 0.02em)[#smallcaps("and the crew despair of their lives.")]
  v(0.6em)
}
