...
#let title-page = {
  ...
  v(0.3em)
  text(size: 12pt, weight: "regular", tracking: 0.09em)[#smallcaps("Chapter I · Section the First")]
  v(0.45em)
  text(size: 20pt, weight: "bold", tracking: 0.02em)[#upper("THE HARBOUR AT DAWN")]
  v(0.5em)
  v(0.25em)
  line(length: 26%, stroke: 0.5pt + black)
  v(0.4em)
  text(size: 13pt, weight: "regular", tracking: 0.03em)[#upper("The vessel is provisioned")]
  v(0.6em)
  v(0.6em)
  text(size: 10pt, weight: "regular", tracking: 0.02em)[#smallcaps("Wherein the stores are laid in, the charts examined,")]
  v(0.15em)
  text(size: 10pt, weight: "regular", tracking: 0.02em)[#smallcaps("and the tide awaited.")]
  v(0.6em)
}
