...
#let title-page = {
  ...
  text(size: 12pt, weight: "regular", tracking: 0.08em, style: "italic")[#smallcaps("The Mariner's Library")]
  v(0.8em)
  v(0.25em)
  line(length: 26%, stroke: 0.3pt + black)
  v(0.4em)
  text(size: 26pt, weight: "regular", tracking: 0.12em)[#upper("The Open Sea")]
  v(0.7em)
  text(size: 15pt, weight: "regular", tracking: 0.02em, style: "italic")[#"A Voyage in Four Winds"]
  v(0.7em)
  text(size: 13pt, weight: "regular", tracking: 0.06em)[#smallcaps("Volume the First")]
  v(0.6em)
  text(size: 14pt, weight: "regular", tracking: 0.03em, style: "italic")[#"By a Gentleman of Devon"]
  v(0.7em)
  v(0.5em)
  ...
  v(1fr)
  text(size: 10pt, weight: "regular", tracking: 0.06em)[#smallcaps("London · MDCCC")]
  v(0.3em)
}
