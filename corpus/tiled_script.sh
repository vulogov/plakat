...
# `plakat.tiled.enable` word: SDXL renders at 1280² (above native 1024²) from
# 768 tiles via the pipeline's `generate_tiled` denoise — the scripting
# counterpart of the CLI `--tiled`. Ungated SDXL. Conservatively sized for
# memory-constrained Metal (the .bund explains how to push it higher).
...
echo "✓ wrote corpus/images/script/tiled-valley.png (1280² SDXL, tiled)"
