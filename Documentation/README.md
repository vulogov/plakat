...
| [`CONTROLNET.md`](CONTROLNET.md) | ControlNet conditioning. `--control`, `--control-image`, `--control-strength` flags on generate / portrait / img2img. v0.9 ships depth conditioning; weight mirrors, the strength dial, composition with other features, scenario integration. |
